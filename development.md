...
**🎉 MILESTONE REACHED: full drive-up → pay → charge → receipt flow works on a real phone with mock Maya and a mock OCPP charge point. Next stop (outside this tracker): Maya sandbox keys + the real CSMS/OCPP link.**
